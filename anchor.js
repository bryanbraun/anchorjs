...
function AnchorJS(options) {
  options = options || {};
  options.icon = options.hasOwnProperty('icon') ? options.icon : '¶'; // Accepts characters (and also URLs?)
  options.visible = options.hasOwnProperty('visible') ? options.visible : 'hover'; // Also accepts 'hover'
  options.placement = options.hasOwnProperty('placement') ? options.placement : 'right'; // Also accepts 'left'
